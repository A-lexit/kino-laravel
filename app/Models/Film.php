...
class Film extends Model
{
    ...
    protected $fillable = ['note', 'subject', 'body', 'likes', 'vviews', 'view', 'season_id','quality_id', 'title', 'slug', 'origin_title', 'description', 'category_id', 'thumbnail', 'director_id', 'year_id', 'company_id', 'duration', 'other_actor','rating_id', 'composer_id', 'status_id', 'age_id', 'watch_id', 'duration_id', 'author_id', 'user_id', 'status'];
...
/////////////////////////////////////////////////////////////////////////////
    ...
    public function scopeFirstFilm($query, $slug)
    {
        ...
        return $query->where('slug', $slug)->with(['category'])->firstOrFail();  //orderBy('id', 'desc')
    }
