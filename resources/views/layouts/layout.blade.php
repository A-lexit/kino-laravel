...
<!--            <ul class="navbar-nav ms-auto">-->
    ...
    <nav class="page-navigation header__nav">
        <div class="header__container">
            ...
            <div class="menu-%d0%b3%d0%be%d0%bb%d0%be%d0%b2%d0%bd%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e-container "><ul id="menu-%d0%b3%d0%be%d0%bb%d0%be%d0%b2%d0%bd%d0%b5-%d0%bc%d0%b5%d0%bd%d1%8e" class="menu">
                    ...
                    <li id="menu-item-1838" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-1838 {{activeMainLink()}}"><a href="/" aria-current="page">Головна</a></li>
                    <li id="menu-item-1839" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1839 {{activeLinkMultfilms()}}"><a href="{{ route('categories.single', ['slug' => 'multiki']) }}">Мультики</a></li>
                    <li id="menu-item-1840" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1840 {{activeLinkMultserials()}}"><a href="{{ route('categories.single', ['slug' => 'multseriali']) }}">Мультсеріали</a></li>
                    <li id="menu-item-1841" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1841 {{activeLinkFilms()}}"><a href="{{ route('categories.single', ['slug' => 'filmi']) }}">Фільми</a></li>
                    <li id="menu-item-1841" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1841 {{activeLinkSerials()}}"><a href="{{ route('categories.single', ['slug' => 'seriali']) }}">Серіали</a></li>
