                        ...
                        <form role="form" method="post" action="{{ route('films.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">             {{--Бралось з demo adminlte  (textarea)--}}
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="3" placeholder="Цитата ..." >{{old('description')}}</textarea>        {{--10 щоб незаповнене поле підсвічувалось червоним is-invalid--}}
                                </div>
